...
const CompanyOrdersScreenWrapper = () => {
  ...
  return (
    <div>
      <style>{`
        .company-orders-header .back-button {
          display: none;
        }
      `}</style>
      <CompanyOrdersScreen company={company} onBack={handleBack} onLogout={handleLogout} />
    </div>
  );
};

export default CompanyOrdersScreenWrapper;
