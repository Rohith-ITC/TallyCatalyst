...
import { getApiUrl, GOOGLE_DRIVE_CONFIG } from '../config';
                  ...
                  <>
                    <div>
                      ...
                      <div style={{ position: 'relative', display: 'flex', gap: '8px' }}>
                        ...
                        <button
                          type="button"
                          onClick={() => openDrivePicker('gst')}
                          disabled={isUploadingDocument.gst}
                          style={{
                            padding: '10px 16px',
                            ...
                            border: 'none',
                            borderRadius: '8px',
                            cursor: isUploadingDocument.gst ? 'wait' : 'pointer',
                            display: 'flex',
                            alignItems: 'center',
                            gap: '6px',
                            fontSize: '14px',
                ...
                {(formData.tax_type === 'PAN' || formData.tax_type === 'GST') && (
                  <div>
                    ...
                    <div style={{ position: 'relative', display: 'flex', gap: '8px' }}>
                      ...
                      <button
                        type="button"
                        onClick={() => openDrivePicker('pan')}
                        disabled={isUploadingDocument.pan}
                        style={{
                          padding: '10px 16px',
                          backgroundColor: '#3b82f6',
                          color: '#fff',
                          border: 'none',
                          borderRadius: '8px',
                          cursor: isUploadingDocument.pan ? 'wait' : 'pointer',
                          display: 'flex',
                          alignItems: 'center',
                          gap: '6px',
                          fontSize: '14px',
